...
class TimeSeriesInputRecord:
    def __init__(self, Time: str, TimeUnit: str, Version: int, MeasureName: str, MeasureValueType: str, MeasureValue: str = None, MeasureValues: [TimeSeriesMeasureValue] = None, Dimensions: [TimeSeriesDimension] = None):
