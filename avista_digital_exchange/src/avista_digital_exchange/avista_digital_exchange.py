...
class AvistaDigitalExchange(object):
    ...
    def listDataStores(self) -> [DataStore]:
    ...
    def listCollaboratives(self) -> [Collaborative]:
    ...
    def listCollaborativeServices(self, collaborativeId) -> [Service]:
        """Lists all Services shared in the Collaborative"""
        query = collaborative_listCollaborativeServices(self.client, collaborativeId)
        result = query.performQuery()
        return result
     
    def listCollaborativesServiceSharedWith(self, serviceId) -> [Collaborative]:
    ...
    def listTimeSeriesDatabases(self) -> [TimeSeriesDb]:
    ...
    # def queryTimeSeriesDatabase(self, timeSeriesDbId, queryType, startTime, endTime, maxRows, assets, clientToken, queryString, nextToken) -> TimeSeriesQueryResult:
    #     query = timeSeriesDb_queryDatabase(self.client, timeSeriesDbId, queryType, startTime, endTime, maxRows, assets, clientToken, queryString, nextToken)
    #     result = query.performQuery()
    #     return result

    def queryTimeSeriesDatabaseWithTimestreamFormat(self, timeSeriesDbId, queryString, maxRows = None, nextToken = None, clientToken = None) -> QueryResult_TimestreamVariables:
    ...
    # def listTimeSeriesAssetLastValues(self, timeSeriesDbId, clientToken, nextToken) -> TimeSeriesLastValuesQueryResult:
    #     query = timeSeriesDb_listAllAssetLastValues(self.client, timeSeriesDbId)
    #     result = query.performQuery()
    #     return result
    ...
    def publishToTimeSeriesDatabase(self, timeSeriesDbId, assetId, records) -> [TimeSeriesAssetData]:
