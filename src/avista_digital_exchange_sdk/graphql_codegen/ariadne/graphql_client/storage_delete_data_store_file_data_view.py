...
class StorageDeleteDataStoreFileDataView(BaseModel):
    storage_delete_data_store_file_data_view: Optional[
        "StorageDeleteDataStoreFileDataViewStorageDeleteDataStoreFileDataView"
    ] = Field(alias="storage_deleteDataStoreFileDataView")


class StorageDeleteDataStoreFileDataViewStorageDeleteDataStoreFileDataView(BaseModel):
...
StorageDeleteDataStoreFileDataView.update_forward_refs()
StorageDeleteDataStoreFileDataViewStorageDeleteDataStoreFileDataView.update_forward_refs()
