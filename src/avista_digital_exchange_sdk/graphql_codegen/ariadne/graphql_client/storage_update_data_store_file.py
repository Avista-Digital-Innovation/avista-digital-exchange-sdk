...
class StorageUpdateDataStoreFile(BaseModel):
    storage_update_data_store_file: Optional[
        "StorageUpdateDataStoreFileStorageUpdateDataStoreFile"
    ] = Field(alias="storage_updateDataStoreFile")


class StorageUpdateDataStoreFileStorageUpdateDataStoreFile(BaseModel):
...
StorageUpdateDataStoreFile.update_forward_refs()
StorageUpdateDataStoreFileStorageUpdateDataStoreFile.update_forward_refs()
