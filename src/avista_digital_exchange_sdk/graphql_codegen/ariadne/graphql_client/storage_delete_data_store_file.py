...
class StorageDeleteDataStoreFile(BaseModel):
    storage_delete_data_store_file: Optional[
        "StorageDeleteDataStoreFileStorageDeleteDataStoreFile"
    ] = Field(alias="storage_deleteDataStoreFile")


class StorageDeleteDataStoreFileStorageDeleteDataStoreFile(BaseModel):
...
StorageDeleteDataStoreFile.update_forward_refs()
StorageDeleteDataStoreFileStorageDeleteDataStoreFile.update_forward_refs()
