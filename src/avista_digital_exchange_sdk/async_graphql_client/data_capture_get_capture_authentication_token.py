...
class DataCaptureGetCaptureAuthenticationToken(BaseModel):
    data_capture_get_capture_authentication_token: Optional[
        "DataCaptureGetCaptureAuthenticationTokenDataCaptureGetCaptureAuthenticationToken"
    ] = Field(alias="dataCapture_getCaptureAuthenticationToken")


class DataCaptureGetCaptureAuthenticationTokenDataCaptureGetCaptureAuthenticationToken(
    BaseModel
):
...
DataCaptureGetCaptureAuthenticationToken.update_forward_refs()
DataCaptureGetCaptureAuthenticationTokenDataCaptureGetCaptureAuthenticationToken.update_forward_refs()
